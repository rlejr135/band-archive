...
public final class UploadStore extends SQLiteOpenHelper {
  ...
  public static final class Task { public String id,uri,name,mime,fingerprint,api,target,state,session,capability,error,result; public long bytes,updated,leaseExpires; public int workId,progress,attempts; }
}
